...
if __name__ == '__main__':
    ...
    # result = [[0, 0, [None]]]
    # for n in np.arange(1, 52, 1):
    #     csv_file = "sRGB_CIELab.csv"
    #     hexs, de = multi_run(n+1, [1, 1, 1], color_space='sRGB',
    #                          uniform_space='CIE Lab', quality='medium', num_runs=32, show=False)
    #     hexs = [f"'{h}'" for h in hexs]
    #     result.append([n+1, de, hexs])
    #
    #     with open(csv_file, "w", newline='') as f:
    ...
    #             writer.writerow(new_row)
    #
    # # sRGB_x_Japan2001Coated_CIELab
    # result = [[0, 0, [None]]]
    # for n in np.arange(1, 52, 1):
    #     csv_file = "sRGB_x_Japan2001Coated_CIELab.csv"
    #     hexs, de = multi_run(n+1, [1, 1, 1], color_space='CMYK',
    #                          uniform_space='CIE Lab', quality='medium', num_runs=32, show=False)
    #     hexs = [f"'{h}'" for h in hexs]
    #     result.append([n+1, de, hexs])
